...
import 'package:courier_app/features/transaction_branch_to_hq/presentation/widgets/transaction_branch_to_hq_table.dart';
...
class TransactionBranchToHqScreen extends StatefulWidget {
  ...
  @override
  State<TransactionBranchToHqScreen> createState() =>
      _TransactionBranchToHqScreenState();
}

class _TransactionBranchToHqScreenState
    extends State<TransactionBranchToHqScreen> {
  ...
  void _fetchTransactions() {
    if (_selectedBranchId != null) {
      ...
      context.read<TransactionBranchToHqBloc>().add(
            FetchTransactions(
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // Main Content
              Expanded(
                child: BlocBuilder<TransactionBranchToHqBloc,
                    TransactionBranchToHqState>(
                  builder: (context, state) {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: TransactionBranchToHqTable(
