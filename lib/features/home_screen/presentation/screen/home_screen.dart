...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadRoleDisplay() async {
  ...
  Widget build(BuildContext context) {
    ...
    final quickActions = <Widget>[
      if (_can(AppPermissions.addShipment))
      ...
      if (_can(AppPermissions.trackShipment))
        HomeWidgets.buildQuickActionCard(
          ...
          isDarkMode: isDarkMode,
          onTap: () => _openWithPermission(
            AppPermissions.trackShipment,
            'You do not have permission to track shipment',
            const TrackShipmentScreen(),
          ),
        ),
      if (_can(AppPermissions.changeShipmentStatus))
        HomeWidgets.buildQuickActionCard(
          context: context,
          ...
          isDarkMode: isDarkMode,
          onTap: () => _openWithPermission(
            AppPermissions.changeShipmentStatus,
  ...
  void _openWithPermission(
    ...
    if (PermissionGuard.has(permissions, permission)) {
      Navigator.push(
        context,
