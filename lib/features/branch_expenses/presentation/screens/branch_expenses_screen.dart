...
class BranchExpensesScreen extends StatefulWidget {
  ...
  @override
  State<BranchExpensesScreen> createState() => _BranchExpensesScreenState();
}

class _BranchExpensesScreenState extends State<BranchExpensesScreen> {
  ...
  void _fetchExpenses() {
    if (_selectedBranchId != null) {
      ...
      context.read<BranchExpensesBloc>().add(
            FetchBranchExpenses(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // Expenses Table
            Expanded(
              child: BlocBuilder<BranchExpensesBloc, BranchExpensesState>(
                builder: (context, state) {
                  ...
                  if (state is BranchExpensesError) {
                    return Center(
                      child: Column(
                  ...
                  if (state is BranchExpensesLoaded) {
