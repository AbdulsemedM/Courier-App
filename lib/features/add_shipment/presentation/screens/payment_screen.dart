                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow(
                              'Name', widget.formData['senderName'] ?? 'N/A'),
                          _buildInfoRow('Mobile',
                              widget.formData['senderMobile'] ?? 'N/A'),
                          _buildSectionTitle('Receiver Information'),
                          _buildInfoRow(
                              'Name', widget.formData['receiverName'] ?? 'N/A'),
                          _buildInfoRow('Mobile',
                              widget.formData['receiverMobile'] ?? 'N/A'),
                          _buildSectionTitle('Shipment Details'),
                          _buildInfoRow('Description',
                              widget.formData['shipmentDescription'] ?? 'N/A'),
                          _buildInfoRow('Quantity',
                              widget.formData['quantity']?.toString() ?? '1'),
                          _buildInfoRow('Number of Pieces',
                              widget.formData['numPcs']?.toString() ?? '0'),
                          _buildInfoRow('Number of Boxes',
                              widget.formData['numBoxes']?.toString() ?? '0'),
                          _buildSectionTitle('Payment Information'),
                          _buildInfoRow('Rate',
                              '${widget.formData['rate']?.toString() ?? '0.00'} ETB'),
                          const Divider(color: Colors.deepPurple),
                          _buildInfoRow('Total Amount', '$totalAmount ETB',
                              highlight: true),
                        ],
                      ),
                    ),
