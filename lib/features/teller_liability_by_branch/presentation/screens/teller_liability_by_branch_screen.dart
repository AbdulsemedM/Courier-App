...
import 'package:courier_app/features/teller_liability_by_branch/bloc/teller_liability_by_branch_bloc.dart';
...
class TellerLiabilityByBranchScreen extends StatefulWidget {
  ...
  @override
  State<TellerLiabilityByBranchScreen> createState() =>
      _TellerLiabilityByBranchScreenState();
}

class _TellerLiabilityByBranchScreenState
    extends State<TellerLiabilityByBranchScreen> {
  ...
  void _fetchTellerLiabilities() {
    if (_selectedBranchId != null) {
      context.read<TellerLiabilityByBranchBloc>().add(
            FetchTellerLiabilitiesByBranch(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Search',
                              hintText: 'Search by teller, reference...',
              ...
              Expanded(
                child: Container(
                  ...
                  child: BlocListener<TellerLiabilityByBranchBloc,
                      TellerLiabilityByBranchState>(
                    listener: (context, state) {
                      if (state is TellerLiabilityByBranchLoaded) {
                        setState(() {
                    ...
                    child: BlocBuilder<TellerLiabilityByBranchBloc,
                        TellerLiabilityByBranchState>(
                      builder: (context, state) {
                        if (state is TellerLiabilityByBranchLoading) {
                          return const Center(child: CircularProgressIndicator());
                        }

                        if (state is TellerLiabilityByBranchError) {
                          return Center(
                            child: Column(
                        ...
                        if (state is TellerLiabilityByBranchLoaded ||
                            _filteredLiabilities.isNotEmpty) {
